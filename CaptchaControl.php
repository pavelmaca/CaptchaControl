 ...
 *
 * @author Pavel Máca
 * @link http://scripts.inseo.cz/nette/captcha-control
...
class CaptchaControl extends \Nette\Forms\TextBase {
    ...
    public static function register() {
        ...
        self::$session = $session->getNamespace('Extras.CaptchaControl');
    ...
    public function setTextColor($rgb) {
        if (!isset($rgb["red"]) || !isset($rgb["green"]) || !isset($rgb["blue"])) {
            throw new \InvalidArgumentException("TextColor must be valid rgb array, see Image::rgb()");
        }
    ...
    public function setBackgroundColor($rgb) {
        if (!isset($rgb["red"]) || !isset($rgb["green"]) || !isset($rgb["blue"])) {
            throw new \InvalidArgumentException("BackgroundColor must be valid rgb array, see Image::rgb()");
        }
